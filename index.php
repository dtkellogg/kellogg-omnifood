...
<html lang="en">
  <head>
    ...
    <meta
      name="description"
      content="Omnifood is a premium food delivery service with the mission to bring affordable and healthy food to as many people as possible."
    />
    <!-- tells mobile phones that they should not zoom out and always start with a
    scale of 1.0 */ -->
    <link rel="stylesheet" type="text/css" href="vendors/css/normalize.css" />
    <link rel="stylesheet" type="text/css" href="vendors/css/grid.css" />
    <!-- <link rel="icons" type="icons" href="icons" /> -->
  ...
  <body>
    <header>
      <nav>
        <div class="row">
          <img
            src="resources/css/img/logo-white.png"
            alt="Omnifood logo"
            class="logo"
          />
          <img
          ...
          <ion-icon name="menu" class="mobile-nav-icon js--nav-icon"></ion-icon>
    ...
    <section class="section-meals">
      <ul class="meals-showcase clearfix">
        <li>
          <figure class="meal-photo">
            <img
              src="resources/css/img/1.jpg"
              alt="Korean bibimap with egg and vegetables"
            />
          </figure>
        </li>
        <li>
          <figure class="meal-photo">
            <img src="resources/css/img/2.jpg" alt="Italian pizza " />
          </figure>
        </li>
        <li>
          <figure class="meal-photo">
            <img src="resources/css/img/3.jpg" alt="Chick breast steak " />
          </figure>
        </li>
        <li>
          <figure class="meal-photo">
      ...
      <ul class="meals-showcase clearfix">
        <li>
          <figure class="meal-photo">
            <img src="resources/css/img/5.jpg" alt="beef steak" />
          </figure>
        </li>
        <li>
          <figure class="meal-photo">
            <img src="resources/css/img/6.jpg" alt="baguette" />
          </figure>
        </li>
        <li>
          <figure class="meal-photo">
            <img src="resources/css/img/7.jpg" alt="burger" />
          </figure>
        </li>
        <li>
          <figure class="meal-photo">
            <img src="resources/css/img/8.jpg" alt="granola" />
          </figure>
        </li>
      </ul>
    </section>
    ...
    <section class="section-steps" id="works">
      ...
      <div class="row">
        <div class="col span-1-of-2 steps-box">
          <img
            src="resources/css/img/app-iPhone.png"
        ...
        <div class="col span-1-of-2 steps-box">
          ...
          <a href="#" class="btn-app"
            ><img
              src="resources/css/img/download-app.svg"
              alt="App Store Button"
          /></a>
          <a href="#" class="btn-app"
            ><img
              src="resources/css/img/download-app-android.png"
      ...
      <div class="row">
        <div class="col span-1-of-3">
          <blockquote>
            ...
            <cite
              ><img src="resources/css/img/customer-1.jpg" alt="" />Alberto
              Duncan</cite
            >
          </blockquote>
        </div>
        <div class="col span-1-of-3">
          <blockquote>
            ...
            even close to Omnifood. My family and I are in love!
            <cite
              ><img src="resources/css/img/customer-2.jpg" alt="" /> Joana
              Silva</cite
            >
          </blockquote>
        </div>
        <div class="col span-1-of-3">
          <blockquote>
            ...
            <cite
              ><img src="resources/css/img/customer-3.jpg" alt="" />Milton
              Chapman
            </cite>
          </blockquote>
        </div>
          ...
          <div class="plan-box js--wp-4">
            ...
            <div>
              <ul>
                ...
                <li>
                  <ion-icon name="checkmark" class="icon-small"></ion-icon>Order
                  24/7
                </li>
                <li>
    ...
    <script src="https://cdn.jsdelivr.net/npm/respond@1.4.2/main.min.js"></script>
    ...
    <!-- putting scripts should be put here so that they are only called after the rest of the page is loaded -->
    <!-- Your own scripts should be the last ones -->
  </body>
</html>
